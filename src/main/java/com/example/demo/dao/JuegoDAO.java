...
/**
 * Interfaz que hereda de las interfaces JuegoDaoCustom y el JpaRepository, para crear los metodos de gestión de la base de datos
...
public interface JuegoDAO extends JpaRepository<Juego, Integer>, JuegoDaoCustom {
	/**
	 * Método que proporciona los juegos cuya plataforma haya sido fabricada por un fabricante dado
	 * @param fabricante
	...
	/**
	 * Método que proporciona los juegos cuya fecha (año) coincida con una dada (año)
	 * @param fecha
	 * @return lista de juegos
	 */
	public List<Juego> findAllByFecha(int fecha);
	/**
	 * Método que proporciona todos los juegos cuyas ventas en Europa sean mayores a la media de ventas en Europa
	 * @return lista de juegos
	 */
	...
	/**
	 * Método que proporciona los distintos editores que aparecen en la base de datos
