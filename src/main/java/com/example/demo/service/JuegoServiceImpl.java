...
/**
 * Proporciona un medio parar crear y formatear un archivo de documento de
 * lenguaje, con espacios de nombres, elementos y atributos apropiados de una
 * lista de juegos que describen nuestro servicio web.
 * 
...
public class JuegoServiceImpl implements JuegoService {
	...
	/**
	 * método para filtrar juegos con ventas por encima de la media en
	 * europa @juegoDao.findAllByEuSalesOverAverage()
	 */
	@Override
